...
module.exports = async function(fastify, opts) {
  ...
  fastify.get('/packages', async () => {
    const pack = await wpManager.listPackages();
    console.log(pack);
    return pack;
  });
...
const extractPackageParameters = ({ params, body }) => ({
  name: params.name || '',
});
...
const getProjectFullPath = ({ projectPath, projectPrefix }) =>
  path.join(projectPath, projectPrefix);
